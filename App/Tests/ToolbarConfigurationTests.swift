...
struct ToolbarConfigurationTests {
    ...
    @Test func everyActionHasACompleteGalleryEntry() {
        ...
        // and its clear + 4.3a Pin loop info + 8.1 Outliner + 6.1 Unwrap UVs + 6.2 Seam flip, its clear and 6.5 Propose seams) with help
        ...
        #expect(EditorAction.allCases.count == 44)
