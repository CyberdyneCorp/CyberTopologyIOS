...
struct ToolbarConfigurationTests {
    ...
    @Test func everyActionHasACompleteGalleryEntry() {
        ...
        // panel + Phase 5 Auto-Retopo) with help content and a demo-media
        // slot; an empty field here would render as a blank help panel.
        #expect(EditorAction.allCases.count == 34)
